...
- ttydをOpen OnDemand 4.1以上で動作させる場合は、Open OnDemandにおいて`strip_proxy_headers:`の設定が必要です（[参照](https://discourse.openondemand.org/t/the-ttyd-not-working-in-ood-4-1-1/4757/12)）。また、ttydはSafari Webブラウザでは動作しません（[参照](https://github.com/tsl0922/ttyd/issues/1437)）。
