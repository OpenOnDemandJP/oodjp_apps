...
- [本家のttyd](https://github.com/tsl0922/ttyd)はコマンドラインからワンタイムパスワードを設定するため、環境によってはpsコマンドでそのパスワードが見えてしまいます。そこで、環境変数経由でワンタイムパスワードを設定できる[ttyd](https://github.com/OpenOnDemandJP/ttyd)をforkして用いています。